...
fun GameStatus(
    ...
    Row(
        ...
        Text(
            text = stringResource(R.string.word_count, wordCount), //stringResource(R.string.word_count, 1),
            fontSize = 18.sp,
        )
        Text(
            modifier = Modifier
            ...
            text = stringResource(R.string.score, score),//stringResource(R.string.score, 0),
            fontSize = 18.sp,
        )
    }
}
